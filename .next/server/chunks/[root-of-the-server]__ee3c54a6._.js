module.exports = [
"[project]/.next-internal/server/app/api/booklibrary/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$books$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/books.ts [app-route] (ecmascript)"); // Make sure the path is correct
;
;
;
const allowedOrigins = [
...
async function POST(req) {
    try {
        ...
        const body = await req.json();
        const newBook = new __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$books$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Book"](body);
        await newBook.save();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ee3c54a6._.js.map