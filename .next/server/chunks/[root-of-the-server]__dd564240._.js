...
"[project]/models/books.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs)");
;
const booksschema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["Schema"]({
    title: String,
    author: String,
    description: String,
    imageUrl: String,
    ...
    timestamps: true,
    collection: "books"
}); // ✅ Yahan collection ka naam 'books' specify kiya gaya hai
const Book = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].models.Book || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model("Book", booksschema, 'books');
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$books$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/books.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$promos$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/promos.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(req) {
    try {
        ...
        const body = await req.json();
        if (body.type === "book") {
            const newBook = new __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$books$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Book"](body.data);
            await newBook.save();
        ...
        if (body.type === "promo") {
            const newPromo = new __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$promos$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Promo"](body.data);
            await newPromo.save();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
                data: newPromo
...
const revalidate = 0; // Next.js ko cache rokne ke liye
async function GET(req) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectToDatabase"])();
        // Yahan books aur promos ko alag alag fetch kar rahe hain
        const books = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$books$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Book"].find({});
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(allContent, {
            status: 200
        });
    } catch (error) {
        console.error("GET error:", error);
...
async function PUT(req) {
    try {
        ...
        if (contentType === "book") {
            const updatedBook = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$books$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Book"].findByIdAndUpdate(id, data, {
                new: true
            });
            if (!updatedBook) {
                return withCORS(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(req) {
    try {
        ...
        if (contentType === "book") {
            const deletedBook = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$books$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Book"].findByIdAndDelete(id);
            if (!deletedBook) {
                return withCORS(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    success: false,
                    message: "Book not found"
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dd564240._.js.map