...
const Book = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].models.Book || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model("Book", bookSchema, 'books');
}}),
...
async function POST(req) {
    try {
        ...
        if (contentType === "book") {
            ...
            const book = new __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$book$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Book"]({
                title,
                author,
                description,
                imageUrl,
        ...
        if (contentType === "image") {
            ...
            const promo = new __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$promoimage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Promo"]({
                promoImageUrl,
                isActive,
                contentType: "image",
                title
...
async function GET(req) {
    try {
        ...
        const books = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$book$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Book"].find({});
        const promos = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$promoimage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Promo"].find({});
        const allContent = [
            ...books.map((b)=>({
                    ...b.toObject(),
                    contentType: "book"
...
async function PUT(req) {
    try {
        ...
        if (contentType === "book") {
            const updatedBook = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$book$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Book"].findByIdAndUpdate(id, data, {
                new: true
            });
            if (!updatedBook) {
                return withCORS(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (contentType === "image") {
            const updatedPromo = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$promoimage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Promo"].findByIdAndUpdate(id, data, {
                new: true
            });
            if (!updatedPromo) {
                return withCORS(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__653e4ace._.js.map