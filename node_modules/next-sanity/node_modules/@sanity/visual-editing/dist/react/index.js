...
const DocumentReporter = (props) => {
  ...
  bb0: {
    ...
    let t142;
    $[15] !== comlink || $[16] !== componentResolver || $[17] !== dragMinimapTransition || $[18] !== dragShowMinimap || $[19] !== elements || $[20] !== inFrame || $[21] !== isDragging || $[22] !== optimisticActorReady || $[23] !== props.plugins || $[24] !== wasMaybeCollapsed ? (t142 = elements.filter(_temp0).map((t152) => {
      const {
        id,
        element: element_0,
        focused,
