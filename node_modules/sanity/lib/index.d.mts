 ...
 * @beta
 */
export declare type DocumentActionsVersionType = 'published' | 'draft' | 'revision' | 'version'
...
/** @internal */
export declare function getReleaseTone(release: SelectedPerspective): BadgeTone
...
export declare const operatorDefinitions: (
  ...
  | (SearchOperatorBuilder<'arrayReferenceIncludes', Reference> & {
      ...
      buttonValueComponent: SearchOperatorButtonValue<ReferenceValue>
      groqFilter: ({fieldPath, value}: SearchOperatorParams<Reference>) => string | null
      initialValue: null
      inputComponent: SearchOperatorInput<ReferenceValue>
  ...
  | (SearchOperatorBuilder<'assetFileEqual', Reference> & {
      ...
      inputComponent: ({
        onChange,
        value,
      }: OperatorInputComponentProps<ReferenceValue>) => JSX.Element
      label: string
      type: 'assetFileEqual'
    })
...
declare const searchOperators: {
  ...
  referencesAssetFile: SearchOperatorBuilder<'referencesAssetFile', Reference> & {
    ...
    groqFilter: ({value}: SearchOperatorParams<Reference>) => string | null
    initialValue: null
    inputComponent: ({onChange, value}: OperatorInputComponentProps<ReferenceValue>) => JSX.Element
    type: 'referencesAssetFile'
  }
 ...
 * @beta
 */
export declare type SelectedPerspective = ReleaseDocument | 'published' | 'drafts'
...
/** @internal */
export declare type SystemBundle = (typeof systemBundles)[number]

/** @internal */
declare type SystemBundleName = (typeof systemBundleNames)[number]

/** @internal */
declare const systemBundleNames: readonly ['draft', 'published']
