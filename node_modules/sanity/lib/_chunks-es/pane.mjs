...
function PaneContextMenuItem(props) {
  ...
  let t5;
  $[4] !== node.icon || $[5] !== node.onAction || $[6] !== node.selected || $[7] !== node.tone || $[8] !== t1 || $[9] !== t2 || $[10] !== t3 || $[11] !== t4 || $[12] !== title ? (t5 = /* @__PURE__ */ jsx(MenuItem$1, { disabled: t1, hotkeys: t2, icon: node.icon, iconRight: t3, onClick: node.onAction, pressed: node.selected, text: title, tone: node.tone, "data-testid": t4 }), $[4] = node.icon, $[5] = node.onAction, $[6] = node.selected, $[7] = node.tone, $[8] = t1, $[9] = t2, $[10] = t3, $[11] = t4, $[12] = title, $[13] = t5) : t5 = $[13];
  let t6;
...
function CommentsProviderWrapper(props) {
  const $ = c(27), {
    ...
    studioUrl
  } = useStudioUrl(window.location.origin), {
    resolveIntentLink
  ...
  let t2;
  $[3] !== documentId || $[4] !== documentType || $[5] !== resolveIntentLink || $[6] !== studioUrl ? (t2 = (commentId) => {
  ...
  }, $[3] = documentId, $[4] = documentType, $[5] = resolveIntentLink, $[6] = studioUrl, $[7] = t2) : t2 = $[7];
  ...
  }, $[8] = setParams, $[9] = t3) : t3 = $[9];
  const handleClearSelectedComment = t3;
  let t4;
  $[10] !== inspector?.name || $[11] !== openInspector ? (t4 = () => {
    inspector?.name !== COMMENTS_INSPECTOR_NAME && openInspector(COMMENTS_INSPECTOR_NAME);
  }, $[10] = inspector?.name, $[11] = openInspector, $[12] = t4) : t4 = $[12];
  const handleOpenCommentsInspector = t4;
  if (!enabled) {
    let t52;
    return $[13] !== children ? (t52 = /* @__PURE__ */ jsx(Fragment, { children }), $[13] = children, $[14] = t52) : t52 = $[14], t52;
  }
  const t5 = inspector?.name === COMMENTS_INSPECTOR_NAME, t6 = connectionState === "connecting";
  let t7;
  return $[15] !== children || $[16] !== documentId || $[17] !== documentType || $[18] !== getCommentLink || $[19] !== handleClearSelectedComment || $[20] !== handleOpenCommentsInspector || $[21] !== onPathOpen || $[22] !== selectedCommentId || $[23] !== selectedReleaseId || $[24] !== t5 || $[25] !== t6 ? (t7 = /* @__PURE__ */ jsx(CommentsProvider, { documentId, documentType, getCommentLink, isCommentsOpen: t5, isConnecting: t6, onClearSelectedComment: handleClearSelectedComment, onCommentsOpen: handleOpenCommentsInspector, onPathOpen, selectedCommentId, sortOrder: "desc", type: "field", releaseId: selectedReleaseId, children }), $[15] = children, $[16] = documentId, $[17] = documentType, $[18] = getCommentLink, $[19] = handleClearSelectedComment, $[20] = handleOpenCommentsInspector, $[21] = onPathOpen, $[22] = selectedCommentId, $[23] = selectedReleaseId, $[24] = t5, $[25] = t6, $[26] = t7) : t7 = $[26], t7;
}
...
function useStructureToolSetting(namespace, key, defaultValue) {
  ...
  if ($[3] !== defaultValue || $[4] !== keyValueStore || $[5] !== keyValueStoreKey) {
    let t32;
    $[7] !== defaultValue ? (t32 = (value) => value === null ? defaultValue : value, $[7] = defaultValue, $[8] = t32) : t32 = $[8], t2 = keyValueStore.getKey(keyValueStoreKey).pipe(map$1(t32)), $[3] = defaultValue, $[4] = keyValueStore, $[5] = keyValueStoreKey, $[6] = t2;
  } else
    t2 = $[6];
  t1 = t2;
...
function DocumentNotInReleaseBanner({
  ...
  }, [createVersion, currentRelease._id, documentId, t, toast]), now = useCurrentTime(200);
...
function OpenReleaseToEditBannerInner({
  ...
  return /* @__PURE__ */ jsx(Banner, { tone, "data-testid": "open-release-to-edit-banner", content: /* @__PURE__ */ jsx(Text, { size: 1, children: /* @__PURE__ */ jsx(Flex, { direction: "row", gap: 1, wrap: "wrap", children: documentVersionsTitleList.length > 1 ? /* @__PURE__ */ jsx(Translate, { t, i18nKey: "banners.release.navigate-to-edit-description-multiple", components: {
...
function DocumentHeaderTitle() {
  ...
  if (connectionState === "connecting" && !subscribed) {
    let t02;
    return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t02 = /* @__PURE__ */ jsx(Fragment, {}), $[0] = t02) : t02 = $[0], t02;
  }
  if (title) {
    let t02;
    return $[1] !== title ? (t02 = /* @__PURE__ */ jsx(Fragment, { children: title }), $[1] = title, $[2] = t02) : t02 = $[2], t02;
  }
  if (!documentValue) {
    const t02 = schemaType?.title || schemaType?.name;
    let t12;
    $[3] !== t || $[4] !== t02 ? (t12 = t("panes.document-header-title.new.text", {
      schemaType: t02
    }), $[3] = t, $[4] = t02, $[5] = t12) : t12 = $[5];
    let t2;
    return $[6] !== t12 ? (t2 = /* @__PURE__ */ jsx(Fragment, { children: t12 }), $[6] = t12, $[7] = t2) : t2 = $[7], t2;
  }
  if (error) {
    let t02;
    $[8] !== error || $[9] !== t ? (t02 = t("panes.document-header-title.error.text", {
      error
    }), $[8] = error, $[9] = t, $[10] = t02) : t02 = $[10];
    let t12;
    return $[11] !== t02 ? (t12 = /* @__PURE__ */ jsx(Fragment, { children: t02 }), $[11] = t02, $[12] = t12) : t12 = $[12], t12;
  }
  let t0;
  $[13] !== documentTitle || $[14] !== t ? (t0 = documentTitle || /* @__PURE__ */ jsx("span", { style: {
    color: "var(--card-muted-fg-color)"
  }, children: t("panes.document-header-title.untitled.text") }), $[13] = documentTitle, $[14] = t, $[15] = t0) : t0 = $[15];
  let t1;
  return $[16] !== t0 ? (t1 = /* @__PURE__ */ jsx(Fragment, { children: t0 }), $[16] = t0, $[17] = t1) : t1 = $[17], t1;
}
const FavoriteToggle = (t0) => {
  ...
  const tabs = t3;
  let t5, t6;
  $[5] !== BackLink2 || $[6] !== showBackButton || $[7] !== t ? (t6 = showBackButton && /* @__PURE__ */ jsx(Button$1, { as: BackLink2, "data-as": "a", icon: ArrowLeftIcon, mode: "bleed", tooltipProps: {
  ...
  bb1: {
    ...
    if (displayed?._id && getVersionFromId(displayed._id) !== selectedReleaseId && ready && !isPinnedDraftOrPublish && isNewDocument(editState) === !1 && !isCurrentVersionGoingToUnpublish) {
      const t162 = selectedPerspective;
      let t172;
      $[52] !== isScheduledRelease || $[53] !== t162 || $[54] !== value._id ? (t172 = /* @__PURE__ */ jsx(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: t162, isScheduledRelease }), $[52] = isScheduledRelease, $[53] = t162, $[54] = value._id, $[55] = t172) : t172 = $[55], t12 = t172;
      break bb1;
    }
    ...
    if (activeView.type === "form" && !selectedReleaseId && displayedHasObsoleteDraft.result) {
      if (displayedHasObsoleteDraft.reason === "DRAFT_MODEL_INACTIVE") {
        let t162;
        $[56] !== displayed || $[57] !== documentId || $[58] !== schemaType ? (t162 = /* @__PURE__ */ jsx(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.obsolete-draft.draft-model-inactive.text" }), $[56] = displayed, $[57] = documentId, $[58] = schemaType, $[59] = t162) : t162 = $[59], t12 = t162;
        break bb1;
      }
      if (displayedHasObsoleteDraft.reason === "LIVE_EDIT_ACTIVE") {
        let t162;
        $[60] !== displayed || $[61] !== documentId || $[62] !== schemaType ? (t162 = /* @__PURE__ */ jsx(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.live-edit-draft-banner.text", isEditBlocking: !0 }), $[60] = displayed, $[61] = documentId, $[62] = schemaType, $[63] = t162) : t162 = $[63], t12 = t162;
        break bb1;
      }
    }
    ...
    let t16;
    $[64] !== showCreateBanner ? (t16 = showCreateBanner && /* @__PURE__ */ jsx(CreateLinkedBanner, {}), $[64] = showCreateBanner, $[65] = t16) : t16 = $[65];
    let t17;
    $[66] !== permissions?.granted || $[67] !== requiredPermission ? (t17 = !permissions?.granted && /* @__PURE__ */ jsx(InsufficientPermissionBanner, { requiredPermission }), $[66] = permissions?.granted, $[67] = requiredPermission, $[68] = t17) : t17 = $[68];
    let t18, t19, t20, t21, t22, t23;
    $[69] === Symbol.for("react.memo_cache_sentinel") ? (t18 = /* @__PURE__ */ jsx(RevisionNotFoundBanner, {}), t19 = /* @__PURE__ */ jsx(ReferenceChangedBanner, {}), t20 = /* @__PURE__ */ jsx(DeprecatedDocumentTypeBanner, {}), t21 = /* @__PURE__ */ jsx(CanvasLinkedBanner, {}), t22 = /* @__PURE__ */ jsx(DeletedDocumentBanners, {}), t23 = /* @__PURE__ */ jsx(UnpublishedDocumentBanner, {}), $[69] = t18, $[70] = t19, $[71] = t20, $[72] = t21, $[73] = t22, $[74] = t23) : (t18 = $[69], t19 = $[70], t20 = $[71], t21 = $[72], t22 = $[73], t23 = $[74]);
    const t24 = displayed?._id ?? documentId;
    let t25;
    $[75] !== isPinnedDraftOrPublish || $[76] !== t24 ? (t25 = /* @__PURE__ */ jsx(OpenReleaseToEditBanner, { documentId: t24, isPinnedDraftOrPublished: isPinnedDraftOrPublish }), $[75] = isPinnedDraftOrPublish, $[76] = t24, $[77] = t25) : t25 = $[77];
    let t26;
    $[78] !== t16 || $[79] !== t17 || $[80] !== t25 ? (t26 = /* @__PURE__ */ jsxs(Fragment, { children: [
      t16,
      t17,
      t18,
      t19,
      ...
      t23,
      t25
    ] }), $[78] = t16, $[79] = t17, $[80] = t25, $[81] = t26) : t26 = $[81], t12 = t26;
  }
  const banners = t12, showFormView = features.resizablePanes || !showInspector;
  let t13;
  $[82] !== activeViewNode || $[83] !== banners || $[84] !== documentScrollElement || $[85] !== footer || $[86] !== formViewHidden || $[87] !== inspectDialog || $[88] !== layoutCollapsed || $[89] !== margins || $[90] !== portalElement || $[91] !== showFormView ? (t13 = showFormView && /* @__PURE__ */ jsxs(Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
    ...
    footer
  ] }), $[82] = activeViewNode, $[83] = banners, $[84] = documentScrollElement, $[85] = footer, $[86] = formViewHidden, $[87] = inspectDialog, $[88] = layoutCollapsed, $[89] = margins, $[90] = portalElement, $[91] = showFormView, $[92] = t13) : t13 = $[92];
  let t14;
  $[93] !== documentId || $[94] !== rootElement || $[95] !== schemaType || $[96] !== showInspector ? (t14 = showInspector && /* @__PURE__ */ jsx(BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[93] = documentId, $[94] = rootElement, $[95] = schemaType, $[96] = showInspector, $[97] = t14) : t14 = $[97];
  let t15;
  return $[98] !== t13 || $[99] !== t14 ? (t15 = /* @__PURE__ */ jsx(PaneContent, { children: /* @__PURE__ */ jsxs(Flex, { height: "fill", children: [
    t13,
    t14
  ] }) }), $[98] = t13, $[99] = t14, $[100] = t15) : t15 = $[100], t15;
};
...
function ConfirmDialogContent(props) {
  ...
  let t6;
  $[11] !== cancelButtonIcon || $[12] !== onCancel || $[13] !== t5 ? (t6 = /* @__PURE__ */ jsx(Button, { "data-testid": "confirm-dialog-cancel-button", icon: cancelButtonIcon, onClick: onCancel, mode: "ghost", text: t5 }), $[11] = cancelButtonIcon, $[12] = onCancel, $[13] = t5, $[14] = t6) : t6 = $[14];
  let t7;
  ...
  let t8;
  $[18] !== confirmButtonIcon || $[19] !== onConfirm || $[20] !== t7 || $[21] !== tone ? (t8 = /* @__PURE__ */ jsx(Button, { "data-testid": "confirm-dialog-confirm-button", icon: confirmButtonIcon, onClick: onConfirm, text: t7, tone }), $[18] = confirmButtonIcon, $[19] = onConfirm, $[20] = t7, $[21] = tone, $[22] = t8) : t8 = $[22];
  let t9;
...
const DISABLED_REASON_KEY = {
  ...
  const {
    ...
    type: "dialog",
    onClose: onComplete,
    content: /* @__PURE__ */ jsx(ConfirmDeleteDialogContainer, { id: draft?._id || id, type, action: "unpublish", onCancel: handleCancel, onConfirm: handleConfirm })
...
const DocumentStatusBarActionsInner = memo(function(props) {
  ...
  let t2;
  $[2] !== t1 ? (t2 = t1.filter(_temp2$6), $[2] = t1, $[3] = t2) : t2 = $[3], t0 = t2;
  const actions = t0;
  let t3, t4;
...
const TooltipContent$1 = (t0) => {
  ...
  }, [displayed?._id, editState?.version, params?.historyVersion]), isPublishSelected = useMemo(() => !!(isLiveEdit && !editState?.draft?._id && !selectedReleaseId || isPublishedId(displayed?._id || "") && isPublishedPerspective(selectedPerspectiveName || "")), [displayed?._id, editState?.draft?._id, isLiveEdit, selectedPerspectiveName, selectedReleaseId]), isDraftSelected = useMemo(() => {
  ...
  const {
    ...
    states
  }) => /* @__PURE__ */ jsx(DocumentPanelHeaderActionDialogDeferred, { contextMenuNodes, setReferenceElement, referenceElement, states }), [contextMenuNodes, referenceElement]), title = useMemo(() => /* @__PURE__ */ jsx(DocumentHeaderTitle, {}), []), backButton = useMemo(() => showBackButton && /* @__PURE__ */ jsx(Button$1, { as: BackLink2, "data-as": "a", icon: ArrowLeftIcon, mode: "bleed", tooltipProps: {
    content: t("pane-header.back-button.text")
...
function DocumentBadges() {
  const $ = c(3), {
    badges,
    editState
  } = useDocumentPane(), renderDocumentBadges = _temp2$5;
  if (!editState || !badges)
    return null;
  let t0;
...
function DocumentLayout() {
  ...
  return schemaType ? /* @__PURE__ */ jsxs(GetFormValueProvider, { value, children: [
    ...
    fieldActions.length > 0 && schemaType && /* @__PURE__ */ jsx(FieldActionsResolver, { actions: fieldActions, documentId, documentType, onActions: setRootFieldActionNodes, path: EMPTY_ARRAY$1, schemaType }),
    /* @__PURE__ */ jsx(FieldActionsProvider, { actions: rootFieldActionNodes, path: EMPTY_ARRAY$1, children: /* @__PURE__ */ jsxs(DocumentActionShortcuts, { actionsBoxElement, as: Pane, currentMinWidth, "data-testid": "document-pane", flex: 2.5, id: paneKey, minWidth, onKeyUp: handleKeyUp, rootRef: setRootElement, children: [
...
function usePreviewUrl(value) {
  ...
  let t4, t5;
  return $[4] !== resolveProductionUrl ? (t5 = subject.asObservable().pipe(distinctUntilChanged$1(), debounceTime(500), switchMap((document2) => isSanityDocument(document2) ? from(resolveProductionUrl({
    document: document2
  })) : of(void 0)), distinctUntilChanged$1(), catchError$1(_temp$c)), $[4] = resolveProductionUrl, $[5] = t5) : t5 = $[5], t4 = t5, useObservable(t4);
}
function _temp$c(err) {
  ...
  return useEffect(() => {
    if (ready && params.path) {
      ...
      if (path !== pathRef.current) {
        const pathFromUrl = resolveKeyedPath(formStateRef.current?.value, fromString(path));
...
const DocumentEventsPane = (props) => {
  ...
  let t12;
  $[19] !== eventsStore.events ? (t12 = eventsStore.events.find(_temp$b)?.id || null, $[19] = eventsStore.events, $[20] = t12) : t12 = $[20];
  let t13;
...
const DocumentPaneWithLegacyTimelineStore = (props) => {
  ...
  const store = useTimelineStore(t1), onOlderRevision = useTimelineSelector(store, _temp$a), revTime = useTimelineSelector(store, _temp2$3), sinceAttributes = useTimelineSelector(store, _temp3$2), timelineDisplayed = useTimelineSelector(store, _temp4$2), timelineReady = useTimelineSelector(store, _temp5$1), isPristine = useTimelineSelector(store, _temp6$1), lastNonDeletedRevId = useTimelineSelector(store, _temp7);
  let t2;
...
function PaneRouterProvider(props) {
  ...
  let t8;
  const t9 = routerPaneGroups[groupIndex] ? routerPaneGroups[groupIndex].length > 1 : !1, t10 = routerPaneGroups[groupIndex] ? routerPaneGroups[groupIndex].length : 0, t11 = flatIndex ? BackLink : void 0;
  let t12, t13;
  ...
  const ctx = t8;
  let t18;
  return $[57] !== children || $[58] !== ctx ? (t18 = /* @__PURE__ */ jsx(PaneRouterContext.Provider, { value: ctx, children }), $[57] = children, $[58] = ctx, $[59] = t18) : t18 = $[59], t18;
}
function _temp$8(siblings_2, item_2) {
...
const paneMap = {
  ...
  let t2;
  $[4] !== PaneComponent || $[5] !== active || $[6] !== index || $[7] !== itemId || $[8] !== pane2 || $[9] !== paneKey || $[10] !== selected || $[11] !== t1 ? (t2 = /* @__PURE__ */ jsx(PaneComponent, { childItemId: t1, index, itemId, isActive: active, isSelected: selected, paneKey, pane: pane2 }), $[4] = PaneComponent, $[5] = active, $[6] = index, $[7] = itemId, $[8] = pane2, $[9] = paneKey, $[10] = selected, $[11] = t1, $[12] = t2) : t2 = $[12];
  let t3;
  $[13] !== t0 || $[14] !== t2 ? (t3 = /* @__PURE__ */ jsx(Suspense, { fallback: t0, children: t2 }), $[13] = t0, $[14] = t2, $[15] = t3) : t3 = $[15];
  let t4;
  return $[16] !== groupIndex || $[17] !== index || $[18] !== params || $[19] !== payload || $[20] !== siblingIndex || $[21] !== t3 ? (t4 = /* @__PURE__ */ jsx(PaneRouterProvider, { flatIndex: index, index: groupIndex, params, payload, siblingIndex, children: t3 }), $[16] = groupIndex, $[17] = index, $[18] = params, $[19] = payload, $[20] = siblingIndex, $[21] = t3, $[22] = t4) : t4 = $[22], t4;
}, ({
  params: prevParams = {},
    ...
    $[43] !== documentTitle ? (t162 = {
      ...
      /* @__PURE__ */ jsxs(Box, { overflow: "auto", paddingTop: 2, children: [
        /* @__PURE__ */ jsxs(Table$1, { children: [
          ...
          /* @__PURE__ */ jsx("tbody", { children: crossDatasetReferences.references.filter(_temp$7).map((t172, index) => {
            const {
              projectId,
              datasetName,
              documentId
...
function useReferringDocuments(documentId) {
  ...
  let t5;
  $[8] !== crossDatasetReferences?.references ? (t5 = () => Array.from(new Set(crossDatasetReferences?.references.map(_temp$6).filter(Boolean))).sort(), $[8] = crossDatasetReferences?.references, $[9] = t5) : t5 = $[9];
  let t6;
  $[10] !== t5 ? (t6 = t5(), $[10] = t5, $[11] = t6) : t6 = $[11];
  const projectIds = t6;
  let t7, t8;
  $[12] !== crossDatasetReferences?.references ? (t8 = Array.from(new Set(crossDatasetReferences?.references.map(_temp2$2).filter(_temp3$1))).sort(), $[12] = crossDatasetReferences?.references, $[13] = t8) : t8 = $[13], t7 = t8;
  const datasetNames = t7;
  let t9;
  $[14] !== crossDatasetReferences?.references ? (t9 = () => !!crossDatasetReferences?.references.some(_temp4$1), $[14] = crossDatasetReferences?.references, $[15] = t9) : t9 = $[15];
...
function _temp4$1(crossDatasetReference_1) {
  return typeof crossDatasetReference_1.datasetName != "string";
}
function _temp3$1(datasetName) {
  return !!datasetName && datasetName !== "";
}
function _temp2$2(crossDatasetReference_0) {
  return crossDatasetReference_0?.datasetName || "";
}
function _temp$6(crossDatasetReference) {
...
const IntentButton = forwardRef(function(props, ref) {
  ...
  const Link2 = t0;
  let t2;
  return $[5] !== Link2 || $[6] !== props.disabled || $[7] !== ref || $[8] !== restProps ? (t2 = props.disabled ? /* @__PURE__ */ jsx(Button$1, { ...restProps, as: "a", role: "link", "aria-disabled": "true" }) : /* @__PURE__ */ jsx(Button$1, { ...restProps, as: Link2, "data-as": "a", ref }), $[5] = Link2, $[6] = props.disabled, $[7] = ref, $[8] = restProps, $[9] = t2) : t2 = $[9], t2;
});
...
function PaneHeaderCreateButton(t0) {
  ...
  let t3;
  t3 = !isTemplatePermissionsLoading && templatePermissions?.length !== 0 && templatePermissions?.every(_temp$5);
  ...
  bb0: {
    ...
    let t52;
    $[6] !== templatePermissions ? (t52 = templatePermissions.reduce(_temp2$1, {}), $[6] = templatePermissions, $[7] = t52) : t52 = $[7], t4 = t52;
  }
  ...
  if (nothingGranted) {
    ...
    let t62;
    $[10] !== t52 ? (t62 = /* @__PURE__ */ jsx(Button$1, { "aria-label": t52, icon: AddIcon, "data-testid": "action-intent-button", disabled: !0, mode: "bleed", tooltipProps: null }), $[10] = t52, $[11] = t62) : t62 = $[11];
    let t72;
  ...
  let t6;
  $[38] !== t5 ? (t6 = /* @__PURE__ */ jsx(Button$1, { icon: AddIcon, mode: "bleed", "data-testid": "multi-action-intent-button", tooltipProps: {
    content: t5
  } }), $[38] = t5, $[39] = t6) : t6 = $[39];
  let t7;
...
function _temp2$1(acc, permission_0) {
  return acc[permission_0.id] = permission_0, acc;
}
function _temp$5(permission) {
...
function MissingSchemaType(props) {
  ...
  let t6;
  return $[12] !== layout || $[13] !== t2 || $[14] !== t5 ? (t6 = /* @__PURE__ */ jsx(SanityDefaultPreview, { title: t2, subtitle: t5, media: _temp$4, layout }), $[12] = layout, $[13] = t2, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
function _temp$4() {
...
`, DocumentListPane = memo(function(props) {
  const {
    ...
    sortOrder
  }), isLoading = documentListIsLoading || releases.loading, handleQueryChange = useObservableEvent((event$) => event$.pipe(map((event) => event.target.value), tap$1(setSearchInputValue), debounce((value) => value === "" ? of("") : timer(300)), tap$1(setSearchQuery))), handleClearSearch = useCallback(() => {
  ...
  let t12;
  $[18] !== features.backButton || $[19] !== index ? (t12 = features.backButton && index > 0 && /* @__PURE__ */ jsx(Button$1, { as: BackLink, "data-as": "a", icon: ArrowLeftIcon, mode: "bleed", tooltipProps: {
    content: "Back"
...
const PaneContainer = memo(function(props) {
  ...
  let t8;
  $[9] !== isSheetListLayout || $[10] !== layout || $[11] !== props || $[12] !== sortOrderRaw ? (t8 = isSheetListLayout ? /* @__PURE__ */ jsx(DocumentSheetListPane, { ...props }, props.pane.id) : /* @__PURE__ */ jsx(DocumentListPane, { ...props, sortOrder: sortOrderRaw, layout }), $[9] = isSheetListLayout, $[10] = layout, $[11] = props, $[12] = sortOrderRaw, $[13] = t8) : t8 = $[13];
...
function EventsTimelineMenu({
  ...
  }, children: /* @__PURE__ */ jsx(Root, { "data-testid": "timeline-menu", constrainSize: !0, content: open && content, "data-ui": "versionMenu", open, placement, matchReferenceWidth: !0, portal: !0, ref: setPopoverRef, children: /* @__PURE__ */ jsx(Flex, { width: "fill", children: /* @__PURE__ */ jsx(Button$1, { "data-testid": open ? "timeline-menu-close-button" : "timeline-menu-open-button", disabled: loading || !events.length, mode: "ghost", onClick: open ? handleClose : handleOpen, ref: setButton, selected: open, width: "fill", tooltipProps: null, justify: "space-between", style: {
    maxWidth: "100%"
...
function DocumentNodePathBreadcrumbs(props) {
  ...
  return pathTitles?.length ? /* @__PURE__ */ jsx(Text, { size: 1, children: pathTitles.map((t, i) => (
